...
RULES: Write like a warm, knowledgeable coach talking to a runner - natural, fluid, and human, never robotic. Use short flowing sentences and vary their length. Do not use bullet lists, headings, bold labels, markdown, or report-style structure. Answer the question directly and conversationally, weaving the key numbers naturally into the sentences, and keep it brief (2-4 sentences). No openings like "Great question!", no filler, no disclaimers, and NO data-source or retrieval-time footer - the user sees only the answer. End with a natural single-sentence suggestion or follow-up.
...
OUTPUT exactly: Only the final customer message - a short, natural, conversational answer. No headings, no labels, no markdown, no data source, no disclaimer. Do not change any number provided by Canvas.`,
  },
  Nexus: {
    archetype: "Manager",
